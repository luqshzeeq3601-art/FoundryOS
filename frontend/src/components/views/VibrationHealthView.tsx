      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-substrate-border pb-4">
        ...
        <div className="flex flex-wrap items-center gap-3">
          <div className="flex items-center gap-2 bg-industrial-900 border border-substrate-border px-3 py-1.5">
            <span className="text-xs font-mono text-industrial-400 uppercase">INSPECT SPINDLE:</span>
            <select
          ...
          <div className="flex items-center gap-1 bg-industrial-900 border border-substrate-border p-1 text-xs font-mono">
      ...
      {fleetSummary && (
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
          <div className="bg-substrate-card/90 border border-substrate-border p-3">
            <div className="text-xs font-mono text-industrial-400 uppercase">FLEET AVG HEALTH</div>
            <div className="text-xl font-mono font-black text-white mt-1">
              {fleetSummary.averageFleetHealthScore}%
            </div>
            <div className="text-xs font-mono text-terminal-green mt-0.5">
              {fleetSummary.totalMachinesAssessed} MACHINES MONITORED
            </div>
          </div>

          <div className="bg-substrate-card/90 border border-substrate-border p-3">
            <div className="text-xs font-mono text-industrial-400 uppercase">ISO ZONE A (GOOD)</div>
            <div className="text-xl font-mono font-black text-terminal-green mt-1">
              {fleetSummary.zoneACount}
            </div>
            <div className="text-xs font-mono text-industrial-400 mt-0.5">OPTIMAL KINEMATICS</div>
          </div>

          <div className="bg-substrate-card/90 border border-substrate-border p-3">
            <div className="text-xs font-mono text-industrial-400 uppercase">ISO ZONE B (ACCEPTABLE)</div>
            <div className="text-xl font-mono font-black text-terminal-cyan mt-1">
              {fleetSummary.zoneBCount}
            </div>
            <div className="text-xs font-mono text-industrial-400 mt-0.5">UNRESTRICTED RUN</div>
          </div>

          <div className="bg-substrate-card/90 border border-substrate-border p-3">
            <div className="text-xs font-mono text-industrial-400 uppercase">ISO ZONE C (ALERT)</div>
            <div className="text-xl font-mono font-black text-hazard-amber mt-1">
              {fleetSummary.zoneCCount}
            </div>
            <div className="text-xs font-mono text-hazard-amber mt-0.5">MAINTENANCE DUE</div>
          </div>

          <div className="bg-substrate-card/90 border border-substrate-border p-3">
            <div className="text-xs font-mono text-industrial-400 uppercase">ISO ZONE D (CRITICAL)</div>
            <div className="text-xl font-mono font-black text-hazard-red mt-1">
              {fleetSummary.zoneDCount}
            </div>
            <div className="text-xs font-mono text-hazard-red mt-0.5">TRIP / SHUTDOWN</div>
          </div>

          <div className="bg-substrate-card/90 border border-substrate-border p-3">
            <div className="text-xs font-mono text-industrial-400 uppercase">AT RISK (SCORE &lt; 60%)</div>
            <div className="text-xl font-mono font-black text-hazard-red mt-1">
              {fleetSummary.criticalCount + fleetSummary.warningCount}
            </div>
            <div className="text-xs font-mono text-industrial-400 mt-0.5">PRESCRIPTIVE ORDERS</div>
          </div>
        </div>
      )}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-4 space-y-6">
          <IndustrialCard className="p-4 space-y-5">
            ...
            <div className="flex flex-col items-center justify-center p-4 bg-black/40 border border-substrate-border">
              <div className={`w-32 h-32 border-4 flex flex-col items-center justify-center shadow-lg ${getHealthScoreColor(latestAssessment?.healthScore || 100)}`}>
                <span className="text-3xl font-mono font-black text-white">
                  {latestAssessment ? latestAssessment.healthScore : 100}%
                </span>
                <span className="text-xs font-mono tracking-widest uppercase text-industrial-400">
                  HEALTH SCORE
                </span>
              </div>
              ...
              <div className="text-xs font-mono text-industrial-400 text-center mt-1">
            ...
            <div className="grid grid-cols-2 gap-2 text-xs font-mono">
              <div className="bg-industrial-900 border border-substrate-border p-2.5">
                <div className="text-xs text-industrial-400 uppercase">VELOCITY RMS</div>
                <div className="text-sm font-bold text-white mt-0.5">
                  {latestAssessment ? latestAssessment.rmsVelocityMmS : 1.42} mm/s
                </div>
                <div className="text-xs text-industrial-500">ISO 10816 10-1000Hz</div>
              </div>

              <div className="bg-industrial-900 border border-substrate-border p-2.5">
                <div className="text-xs text-industrial-400 uppercase flex items-center gap-1">
                ...
                <div className="text-xs text-industrial-500">MAX 75°C LIMIT</div>
              </div>
              ...
              <div className="bg-industrial-900 border border-substrate-border p-2.5">
                ...
                <div className="text-xs text-industrial-500">PEAK / RMS RATIO</div>
              </div>
              ...
              <div className="bg-industrial-900 border border-substrate-border p-2.5">
                ...
                <div className="text-xs text-industrial-500">GAUSSIAN REF ~3.0</div>
              </div>
            </div>
            ...
            <div className="space-y-1.5 font-mono text-xs">
              ...
              <div className="flex justify-between text-xs text-industrial-500">
                <span>0 mm/s</span>
                <span>1.12</span>
                <span>2.80</span>
                <span>7.10</span>
            ...
            <div className="bg-industrial-900/80 border border-substrate-border p-3 space-y-2 text-xs font-mono">
              <div className="flex items-center gap-1.5 text-industrial-300 font-bold uppercase text-xs">
                <ShieldCheck size={14} className="text-terminal-green" /> DIAGNOSTIC ASSESSMENT:
              </div>
              <p className="text-industrial-200 text-xs leading-relaxed">
              ...
              {latestAssessment?.recommendedAction && (
                <div className="pt-2 border-t border-substrate-border text-xs text-hazard-amber">
            ...
            {latestAssessment?.activeWorkOrder && (
              <div className="bg-amber-950/40 border border-amber-500/80 p-3 space-y-2 text-xs font-mono animate-fade-in">
                <div className="flex items-center justify-between">
                  ...
                  <span className="px-1.5 py-0.5 bg-amber-900 border border-amber-600 text-amber-200 text-xs font-bold uppercase">
        ...
        <div className="lg:col-span-8 space-y-6">
          <IndustrialCard className="p-4 space-y-4">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-substrate-border pb-3">
              ...
              {hoveredFrequency && (
                <div className="bg-black/60 border border-cyan-500/50 px-2 py-1 text-xs font-mono text-cyan-300">
            ...
            <div className="relative bg-black/90 border border-substrate-border p-3 h-[240px] flex flex-col justify-end overflow-hidden">
              {/* Grid Lines */}
              <div 
              ...
              {/* Axis markers */}
              <div className="flex justify-between text-xs font-mono text-industrial-400 pt-1 border-t border-substrate-border mt-1">
                <span>0 Hz</span>
                <span>200 Hz</span>
                <span>400 Hz</span>
                <span>600 Hz</span>
          ...
          <IndustrialCard className="p-4 space-y-3">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
              <button
                ...
                className="p-2.5 bg-emerald-950/40 hover:bg-emerald-900/60 border border-emerald-600/60 text-emerald-300 text-xs font-mono font-bold uppercase transition-all flex flex-col items-center gap-1"
              >
                <CheckCircle2 size={16} />
                <span>HEALTHY BASELINE</span>
                <span className="text-xs font-normal text-emerald-400/80">Zone A // 100% Score</span>
              </button>

              <button
                onClick={() => simulateMutation.mutate('UNBALANCE_1X')}
                disabled={simulateMutation.isPending}
                className="p-2.5 bg-industrial-900 hover:bg-industrial-800 border border-substrate-border text-industrial-200 text-xs font-mono font-bold uppercase transition-all flex flex-col items-center gap-1"
              >
                <Disc size={16} className="text-cyan-400" />
                <span>1X ROTOR UNBALANCE</span>
                <span className="text-xs font-normal text-industrial-400">Elevated 1X Run Speed</span>
              </button>

              <button
                onClick={() => simulateMutation.mutate('MISALIGNMENT_2X')}
                disabled={simulateMutation.isPending}
                className="p-2.5 bg-amber-950/40 hover:bg-amber-900/60 border border-amber-600/60 text-amber-300 text-xs font-mono font-bold uppercase transition-all flex flex-col items-center gap-1"
              >
                <AlertTriangle size={16} />
                <span>2X MISALIGNMENT</span>
                <span className="text-xs font-normal text-amber-400/80">Coupling Angular / Offset</span>
              </button>

              <button
                onClick={() => simulateMutation.mutate('BPFO_BEARING_OUTER')}
                disabled={simulateMutation.isPending}
                className="p-2.5 bg-red-950/40 hover:bg-red-900/60 border border-red-600/60 text-red-300 text-xs font-mono font-bold uppercase transition-all flex flex-col items-center gap-1"
              >
                <TrendingDown size={16} />
                <span>BPFO BEARING WEAR</span>
                <span className="text-xs font-normal text-red-400/80">Outer Race Spall ~3.58X</span>
              </button>
            </div>
          </IndustrialCard>
          </>
