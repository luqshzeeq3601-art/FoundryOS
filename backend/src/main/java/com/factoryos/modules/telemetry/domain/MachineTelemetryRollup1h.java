...
@Entity
@Table(name = "machine_telemetry_rollups_1h")
public class MachineTelemetryRollup1h {
    ...
    public MachineTelemetryRollup1h() {
    }

    public MachineTelemetryRollup1h(Machine machine, String tagName, Instant bucketStart, double minValue, double maxValue, double avgValue, int sampleCount, TelemetryQuality quality) {
